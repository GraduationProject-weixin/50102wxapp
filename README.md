...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1BPtKekEv3?p=105)
...
因此，开发合适的旅游社交小程序，可以方便管理人员对旅游社交小程序的管理，提高信息管理工作效率及查询效率，用户可以在手机上通过微信小程序来进行旅游社交，更加的方便，有利于更好的为人们服务。

1.2研究目的

随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。旅游社交小程序的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。

对于之前旅游社交小程序的管理，大部分都是使用传统的人工方式去管理，这样导致了管理效率低下、出错频率高。而且，时间一长的话，积累下来的数据信息不容易保存，对于查询、更新还有维护会带来不少问题。对于数据交接也存在很大的隐患。如果采用电子化的存储方式就会带来很大的改善，而且给用户的查询带来了很大便利，因此设计一个旅游社交小程序刻不容缓，能够提高信息的管理水平。
## 1.3系统设计思想
...
# 3系统分析
## 3.1可行性分析
通过对本旅游社交小程序实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本旅游社交小程序后端采用SSM框架进行开发，是一种成熟的框架，开发有很多教程的，微信开发也有很多教程，并且网络上很多免费的教程。  

因此，旅游社交小程序在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本旅游社交小程序采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本旅游社交小程序的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此旅游社交小程序要严格控制管理权限，具体要求如下：

（1）要想对旅游社交小程序进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
![D:\111sheji\旅游社\ssm4v081\\img\用户.jpg](/md/blog.005.jpeg "D:\111sheji\旅游社\ssm4v081\\img\用户.jpg")
用户实体属性图

（2）下图是收藏表实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\收藏表.jpg](/md/blog.006.jpeg "D:\111sheji\旅游社\ssm4v081\\img\收藏表.jpg")
收藏表实体属性图

（3）下图是每日签到实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\每日签到.jpg](/md/blog.007.jpeg "D:\111sheji\旅游社\ssm4v081\\img\每日签到.jpg")
每日签到实体属性图

（4）下图是周边推荐评论表实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\周边推荐评论表.jpg](/md/blog.008.jpeg "D:\111sheji\旅游社\ssm4v081\\img\周边推荐评论表.jpg")
周边推荐评论表实体属性图

（5）下图是景点推荐评论表实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\景点推荐评论表.jpg](/md/blog.009.jpeg "D:\111sheji\旅游社\ssm4v081\\img\景点推荐评论表.jpg")
景点推荐评论表实体属性图

（6）下图是分享圈评论表实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\分享圈评论表.jpg](/md/blog.010.jpeg "D:\111sheji\旅游社\ssm4v081\\img\分享圈评论表.jpg")
分享圈评论表实体属性图

（7）下图是酒店推荐评论表实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\酒店推荐评论表.jpg](/md/blog.011.jpeg "D:\111sheji\旅游社\ssm4v081\\img\酒店推荐评论表.jpg")
酒店推荐评论表实体属性图

（8）下图是酒店推荐实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\酒店推荐.jpg](/md/blog.012.jpeg "D:\111sheji\旅游社\ssm4v081\\img\酒店推荐.jpg")
酒店推荐实体属性图

（9）下图是景点推荐实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\景点推荐.jpg](/md/blog.013.jpeg "D:\111sheji\旅游社\ssm4v081\\img\景点推荐.jpg")
景点推荐实体属性图

（10）下图是防疫查询实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\防疫查询.jpg](/md/blog.014.jpeg "D:\111sheji\旅游社\ssm4v081\\img\防疫查询.jpg")
防疫查询实体属性图

（11）下图是用户表实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\用户表.jpg](/md/blog.015.jpeg "D:\111sheji\旅游社\ssm4v081\\img\用户表.jpg")
用户表实体属性图

（12）下图是分享圈实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\分享圈.jpg](/md/blog.016.jpeg "D:\111sheji\旅游社\ssm4v081\\img\分享圈.jpg")
分享圈实体属性图

（13）下图是景点分类实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\景点分类.jpg](/md/blog.017.jpeg "D:\111sheji\旅游社\ssm4v081\\img\景点分类.jpg")
景点分类实体属性图

（14）下图是美食推荐评论表实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\美食推荐评论表.jpg](/md/blog.018.jpeg "D:\111sheji\旅游社\ssm4v081\\img\美食推荐评论表.jpg")
美食推荐评论表实体属性图

（15）下图是美食推荐实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\美食推荐.jpg](/md/blog.019.jpeg "D:\111sheji\旅游社\ssm4v081\\img\美食推荐.jpg")
美食推荐实体属性图

（16）下图是周边推荐实体和其具备的属性。

![D:\111sheji\旅游社\ssm4v081\\img\周边推荐.jpg](/md/blog.020.jpeg "D:\111sheji\旅游社\ssm4v081\\img\周边推荐.jpg")
周边推荐实体属性图
### 4.3.2数据库设计表
旅游社交小程序需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|didian|String|地点|是|
|4|fengxiandengji|String|风险等级|是|
|5|lvyoujianyi|String|旅游建议|是|
表4.8分享圈表
...
|6|fenxiangneirong|String|分享内容|是|
...
|5|jingdianleibie|String|景点类别|是|
|6|jingdiandizhi|String|景点地址|是|
|7|jingdiantupian|String|景点图片|是|
|8|jingdianjieshao|String|景点介绍|是|
...
|5|jiudiandizhi|String|酒店地址|是|
|6|zhaopian|String|照片|是|
|7|jiudianjieshao|String|酒店介绍|是|
...
|2|addtime|Date|创建时间|是|
|3|diqu|String|地区|是|
|4|shiwumingcheng|String|食物名称|是|
|5|shiwujianjie|String|食物简介|是|
|6|zhaopian|String|照片|是|
...
|4|jingdiandizhi|String|景点地址|是|
|5|zhoubianmingcheng|String|周边名称|是|
|6|tupian|String|图片|是|
|7|tuijianliyou|String|推荐理由|是|
|8|thumbsupnum|Integer|赞|是|
|9|crazilynum|Integer|踩|是|

![](/md/blog.021.png "打开新的 phpMyAdmin 窗口")
